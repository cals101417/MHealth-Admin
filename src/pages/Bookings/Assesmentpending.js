...
export function Assesmentpending() {
  ...
  const updateStatus = async (id, assessmentStatus) => {
    const assessmentBook = doc(db, "book_assessment", id);
    const newStatus = { assessmentStatus: (assessmentStatus = "Approved") };
    await updateDoc(assessmentBook, newStatus);
  };
  const cancelStatus = async (id, assessmentStatus) => {
    const assessmentBook = doc(db, "book_assessment", id);
    const newStatus = { assessmentStatus: (assessmentStatus = "Cancelled") };
    await updateDoc(assessmentBook, newStatus);
  };
                                  ...
                                  <button
                                    onClick={() => {
                                      if (
                                        ...
                                        cancelStatus(assessmentBook.id);
                                      }
                                    }}
                                  >
